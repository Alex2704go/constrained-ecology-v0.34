# scrape_carbon_bottleneck.py
import urllib.request
import re

url = "https://drive.google.com/drive/folders/15p0jqUOur0OjaoTrcRweYnNXfQqV8ynX?usp=sharing"
headers = {
...
try:
    print("Fetching carbon_bottleneck HTML...")
    with urllib.request.urlopen(req) as response:
        html = response.read().decode('utf-8')
    print("Successfully fetched folder HTML.")
    
    # Save it
    with open("raw_html_carbon_bottleneck.html", "w", encoding="utf-8") as f:
        f.write(html)
